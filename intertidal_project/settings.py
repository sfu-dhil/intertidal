"""
Django settings for intertidal_project project.
...
INSTALLED_APPS = [
    'intertidal_app.apps.IntertidalAppConfig',
    'admin_interface',
    'colorfield',
    'tinymce',
    'nested_admin',
...
ROOT_URLCONF = 'intertidal_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'intertidal_app.context_processors.get_git_info',
            ],
        },
    },
]
