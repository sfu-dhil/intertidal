...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='resource',
            name='categories',
            field=intertidal_app.models.ArrayField(base_field=models.CharField(choices=[('LITERARY_WORK', 'Literary Work'), ('ART_PERFORMANCE', 'Art/Performance'), ('STATE_ARCHITECTURE_MISC', 'State/Architecture/Misc.'), ('NEWS_DOCUMENTARY', 'News/Documentary'), ('ACADEMIC_RESEARCH', 'Academic Research'), ('SOCIAL_MEDIA', 'Social Media')]), db_index=True, default=list, size=None),
        ),
        migrations.AddField(
            model_name='resource',
            name='language',
