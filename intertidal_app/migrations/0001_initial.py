    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alternative_names', intertidal_app.models.ArrayField(base_field=models.CharField(), blank=True, default=list, size=None)),
                ('address', models.CharField(blank=True)),
                ('links', intertidal_app.models.ArrayField(base_field=models.CharField(), blank=True, default=list, size=None)),
                ('emails', intertidal_app.models.ArrayField(base_field=models.CharField(), blank=True, default=list, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('resource', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='occurrences', to='intertidal_app.resource')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('resource', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='editions', to='intertidal_app.resource')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responsibility_statements', to='intertidal_app.organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responsibility_statements', to='intertidal_app.person')),
            ],
            options={
