...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='resourceaudio',
            name='name',
            field=models.CharField(blank=True, verbose_name='File Name'),
        ),
        migrations.AddField(
            model_name='resourceaudio',
            name='transcript',
            field=models.TextField(blank=True, verbose_name='Transcript'),
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            model_name='resource',
            name='categories',
            field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('LITERARY_WORK', 'Literary Work'), ('ART_PERFORMANCE', 'Art/Performance'), ('STATE_ARCHITECTURE_MISC', 'State/Architecture/Misc.'), ('NEWS_DOCUMENTARY', 'News/Documentary'), ('ACADEMIC_RESEARCH', 'Academic Research'), ('SOCIAL_MEDIA', 'Social Media'), ('ROUNDTABLE_INTERVIEW', 'Roundtable/Interview'), ('FIELD_RECORDING', 'Field Recording')]), db_index=True, default=list),
        ),
        migrations.AlterField(
            model_name='resource',
            name='language',
